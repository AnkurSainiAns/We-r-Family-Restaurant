...
let mobile5El = document.getElementById("mobile5")
let feedbackEl = document.getElementById("feedback")
let name5El = document.getElementById("name5")
...
document.addEventListener("DOMContentLoaded", function () {
    let namemEl = document.getElementById("namem");
    let submitmEl = document.getElementById("submitm");
    let spacemEl = document.getElementById("spacem");

    submitmEl.addEventListener("click", function () {
        spacemEl.textContent = "ho gya";
    });
});
